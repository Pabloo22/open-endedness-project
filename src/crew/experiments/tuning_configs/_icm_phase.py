...
DEFAULT_INTRINSIC_MODULES = ("icm",)

ICM_INTRINSIC_BASE_CONFIG_V1: dict[str, Any] = {
    **default_base_params(),
    "selected_intrinsic_modules": ("icm",),
...
def get_icm_base_config_v1() -> dict[str, Any]:
    return {
        "selected_intrinsic_modules": ("icm",),
        "baseline_fixed_training_alpha": (
            1.0 - DEFAULT_BASELINE_INTRINSIC_ALPHA,
...
def get_icm_search_space_v1() -> dict[str, Any]:
    return {
